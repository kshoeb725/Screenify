  ...
  const sections = [
    {
      ...
      content: `Screenify ("we", "our", or "us") refers to the SaaS platform and service operated by individual developer Aadil Jakir Husen Shaikh, based in Mumbai, Maharashtra, India. We are committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your personal information when you visit and use our website (screenify.dev) and SaaS service (collectively, the "Service"). 
