...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Upload screenshots. Get polished Shopify app store promo images with captions, generated by AI." },
      { name: "author", content: "Screenify" },
      { property: "og:title", content: "Screenify — AI-powered Shopify app store screenshots" },
      { property: "og:description", content: "Upload screenshots. Get polished Shopify app store promo images with captions, generated by AI." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Screenify — AI-powered Shopify app store screenshots" },
      { name: "twitter:description", content: "Upload screenshots. Get polished Shopify app store promo images with captions, generated by AI." },
