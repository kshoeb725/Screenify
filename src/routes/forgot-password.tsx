        ...
        {success ? (
          ...
          <div className="space-y-6">
            ...
            <form onSubmit={handleResetRequest} className="space-y-4 text-left">
              ...
              <p className="text-center text-[11px] text-muted-foreground/80 leading-relaxed pt-1 select-none">
                Note: You can only request one reset link per hour. If you do not receive the email, please wait one hour before attempting again.
              </p>
            </form>
